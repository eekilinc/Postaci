  ...
  const handleCheckUpdate = async () => {
    ...
    try {
      ...
      if (res.updateAvailable) {
        ...
        success('En güncel sürümü (v1.0.0) kullanıyorsunuz.');
      }
    } catch (err: any) {
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '8px' }}>
                    <div>
                      ...
                      <div style={{ fontSize: '12px', color: 'var(--text-muted)' }}>
                        Mevcut Kurulu Sürüm: <strong style={{ color: 'var(--accent-primary)' }}>v1.0.0</strong>
                      </div>
                    </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', padding: '32px 0', gap: '14px' }}>
                ...
                <div>
                  ...
                  <p style={{ fontSize: '13px', color: 'var(--text-muted)', marginTop: '4px' }}>
                    Sürüm 1.0.0 (x64 Windows & Linux Desktop)
                  </p>
                </div>
