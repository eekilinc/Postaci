...
export const SnippetIcon = memo(function SnippetIcon({ size = 18, strokeWidth = 2, className = '', ...props }: IconProps) {
  return (
    <svg {...baseProps(size, strokeWidth, className)} {...props}>
...
export const ContactsIcon = memo(function ContactsIcon({ size = 18, strokeWidth = 2, className = '', ...props }: IconProps) {
  return (
    <svg {...baseProps(size, strokeWidth, className)} {...props}>
      <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2" />
      <circle cx="9" cy="7" r="4" />
